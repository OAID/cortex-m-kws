...
#define AUTO_REGISTER_OPS(reg_func) REGISTER_MODULE_INIT(MOD_OP_LEVEL, NULL, reg_func)
#define AUTO_UNREGISTER_OPS(unreg_func) REGISTER_MODULE_EXIT(MOD_OP_LEVEL, NULL, unreg_func);
