...
#define TM2_OP_VER_MAIN 1
#define TM2_OP_VER_SUB 0
#define TM2_OP_VER_COMPILE 0
...
typedef struct
{
    uint16_t op_ver_main; /* main version of operator */
    uint16_t op_ver_sub; /* sub version of operator */
    uint16_t op_ver_compile; /* compile version of operator */
